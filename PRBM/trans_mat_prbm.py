...
#         thx = var((nrb+1)*(iteration-1)+1);
#         thy = var((nrb+1)*(iteration-1)+2);
#         th = sqrt(thx^2+thy^2);
#         theta = [th-sum(var((nrb+1)*(iteration-1)+3:(nrb+1)*(iteration-1)+4)) var((nrb+1)*(iteration-1)+3) var((nrb+1)*(iteration-1)+4)];
#         epsi = var((nrb+1)*(iteration-1)+5);
#         phi = atan2(thy,thx);